...
/// Installs Homebrew.
fn install_homebrew(dry_run: bool) -> Result<()> {
...
fn backup(cfg_path: &std::path::Path, verbose: bool, dry_run: bool) -> Result<()> {
...
fn install_from_config(cfg_path: PathBuf, verbose: bool, dry_run: bool) -> Result<()> {
